...
class Segment:
    ...
    def __getstate__(self):
        ...
        return self._segment_id, self._posting_file, self._number_of_documents, self._is_open, self._max_docs

    def __setstate__(self, state):
        """Restore state from the unpickled state values."""
        self._segment_id, self._posting_file, self._number_of_documents, self._is_open, self._max_docs = state
        self._buffer = {}
    ...
    # TODO Make this an iterator so we can dump terms - read lock needed
